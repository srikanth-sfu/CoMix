...
class ZipItem(object):
    ...
    def __init__(self, video_info: str, zip_fmt: str, frame_fmt: str):
        """
        Example
            zip_fmt='20bn-jester-v1/{}.zip',
            frame_fmt='{:05d}.jpg',
        """
        self.zip_path = zip_fmt.format(video_info)
...
class ZipBackend(object):
    ...
    def open(self, video_info, frame_inds=None) -> ZipItem:
