...
#SBATCH --time=0-03:00
#SBATCH -o /home/smuralid/error/tubelets/comix-ncl_bgmix_pretrain_adapt_moen/ucf_hmdb/slurm-%j.out  # Write the log on scratch
#SBATCH -e /home/smuralid/error/tubelets/comix-ncl_bgmix_pretrain_adapt_moen/ucf_hmdb/slurm-%j.err
...
timeout 170m python main.py --manual_seed 1 --auto_resume True --dataset_name UCF-HMDB \
 ...
 --model_root /scratch/smuralid/checkpoints/da/ucf_hmdb/ncl_comix_baseline_video_pretrain_adapt_moen/ \
 ...
 --pretrain_i3d /scratch/smuralid/checkpoints/da/ucf_hmdb/ncl_comix_baseline_pretrain_moen/I3D-SourceOnly-Online-Model-Best.pth \
