...
--src_dataset UCF --tgt_dataset HMDB --batch_size 8 --model_root /home/smuralid/checkpoints_ucf_hmdb --save_in_steps 500 \
...
--base_dir $SLURM_TMPDIR/ucf_hmdb/ --warmstart_graph_checkpoint /scratch/smuralid/checkpoints/da/ucf_hmdb/original_baseline/
