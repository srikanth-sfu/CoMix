...
# timeout 170m python main.py --manual_seed 1 --auto_resume True --dataset_name UCF-HMDB --src_dataset UCF --tgt_dataset HMDB \
# --batch_size 7 --model_root /scratch/smuralid/checkpoints/da/ucf_hmdb/original_baseline/ --save_in_steps 500 --num_segments 0 
...
# --warmstart_graph /scratch/smuralid/checkpoints/da/ucf_hmdb/original_baseline_ws/Graph-SourceOnly-Model-Best.pth 
# --warmstart_i3d /scratch/smuralid/checkpoints/da/ucf_hmdb/original_baseline_ws/I3D-SourceOnly-Online-Model-Best.pth


timeout 150m python main.py --manual_seed 1 --auto_resume True --dataset_name Jester --src_dataset S --tgt_dataset T \
        --batch_size 7 --model_root /scratch/smuralid/checkpoints/da/jester_st/original_baseline/ \
        --save_in_steps 500 --log_in_steps 50 --num_segments 0 --eval_in_steps 50 --pseudo_threshold 0.7 --warmstart_models True \
