...
#SBATCH --time=0-03:00
#SBATCH -o /home/smuralid/error/tubelets/comix-ncl_bgmix_pretrain_adapt_moen/ek_d1d2/slurm-%j.out  # Write the log on scratch
#SBATCH -e /home/smuralid/error/tubelets/comix-ncl_bgmix_pretrain_adapt_moen/ek_d1d2/slurm-%j.err
...
timeout 150m python main.py --manual_seed 1 --auto_resume True  --dataset_name Epic-Kitchens \
 --src_dataset D1 --tgt_dataset D2 --batch_size 7 --model_root /project/def-mpederso/smuralid/checkpoints/da/ek/d1d2_ncl_comix_baseline_video_pretrain_adapt_moen/ \
 --save_in_steps 500 --num_segments 2 --log_in_steps 50 --eval_in_steps 50 --pseudo_threshold 0.7 --warmstart_models True \
 --num_iter_warmstart 4000 --num_iter_adapt 10000 --learning_rate 0.01 --learning_rate_ws 0.01 --lambda_bgm 0.01 --lambda_tpl 0.01 \
 ...
 --pretrain_i3d /project/def-mpederso/smuralid/checkpoints/da/ek/d1d2_ncl_comix_baseline_pretrain_moen/I3D-SourceOnly-Online-Model-Best.pth \
 --pretrain_graph /project/def-mpederso/smuralid/checkpoints/da/ek/d1d2_ncl_comix_baseline_pretrain_moen/Graph-SourceOnly-Model-Best.pth
if [ $? -eq 124 ]; then
