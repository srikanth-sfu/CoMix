...
mkdir epic_kitchens
# D1: P08, D2: P01
cp /project/def-mpederso/smuralid/datasets/epic_kitchens/epic_kitchens_d1_lmdb.zip $SLURM_TMPDIR/epic_kitchens
cp /project/def-mpederso/smuralid/datasets/epic_kitchens/epic_kitchens_d2_lmdb.zip $SLURM_TMPDIR/epic_kitchens
cp /project/def-mpederso/smuralid/datasets/epic_kitchens/epic_kitchens_bg.zip $SLURM_TMPDIR/epic_kitchens

cd epic_kitchens
unzip -qq epic_kitchens_d1_lmdb.zip
unzip -qq epic_kitchens_d2_lmdb.zip
...
CUDA_VISIBLE_DEVICES=0 timeout 150m python main.py --manual_seed 1 --auto_resume True  --dataset_name Epic-Kitchens \
